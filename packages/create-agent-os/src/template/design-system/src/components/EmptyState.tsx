...
const config: Record<EmptyStateType, {
  ...
  overview: {
    ...
    agentPrompt: "Antigravity, define the product mission. Read 'agent-os/commands/plan-product/2-create-mission.md'.",
  ...
  roadmap: {
    ...
    agentPrompt: "Antigravity, create the product roadmap. Read 'agent-os/commands/plan-product/3-create-roadmap.md'.",
  ...
  'data-model': {
    ...
    command: '/data-model',
    agentPrompt: "Antigravity, let's define the data model. Read 'agent-os/commands/data-model/data-model.md'.",
