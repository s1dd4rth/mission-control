...
export function ExportPage() {
  ...
  const sectionStats = useMemo(() => {
    ...
    const roadmapSectionIds = new Set(sections.map(s => s.id))

    const sectionsWithScreenDesigns = allSectionIds.filter(id => {
      // Only count sections that are actually in the roadmap
      if (!roadmapSectionIds.has(id)) return false
          ...
          <Card className="border-stone-200 dark:border-stone-700 shadow-sm">
            ...
            <CardContent>
              <div className="space-y-1">
                ...
                <ChecklistItem
                  label={`Sections with screen designs (${sectionStats.sectionsWithScreenDesigns} of ${sectionStats.sectionCount} completed)`}
          ...
          <Card className="border-stone-200 dark:border-stone-700 shadow-sm">
            ...
            <CardContent className="space-y-6">
              {exportZipAvailable && exportZipUrl ? (
                ...
                <div className="space-y-4">
                  <p className="text-stone-600 dark:text-stone-400">
                    Run the following command to generate the <code className="font-mono text-stone-800 dark:text-stone-200">product-plan/</code> folder in your project root:
                  </p>
                  <PromptButton
        ...
        <Card className="border-stone-200 dark:border-stone-700 shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <Collapsible defaultOpen>
              ...
              <CollapsibleContent>
                <ol className="text-sm text-stone-600 dark:text-stone-400 space-y-2 list-decimal list-inside mt-4 pl-1">
                  <li>Ensure the <code className="font-mono text-stone-800 dark:text-stone-200">product-plan/</code> folder exists in your project root (generated by export)</li>
                  <li>Start with Foundation (<code className="font-mono text-stone-800 dark:text-stone-200">product-plan/instructions/incremental/01-foundation.md</code>)</li>
                  <li>Then Shell (<code className="font-mono text-stone-800 dark:text-stone-200">product-plan/instructions/incremental/02-shell.md</code>)</li>
                  <li>
                    For each section:
            ...
            <Collapsible>
              ...
              <CollapsibleContent>
                <ol className="text-sm text-stone-600 dark:text-stone-400 space-y-2 list-decimal list-inside mt-4 pl-1">
                  <li>Ensure the <code className="font-mono text-stone-800 dark:text-stone-200">product-plan/</code> folder exists in your project root</li>
                  <li>Open <code className="font-mono text-stone-800 dark:text-stone-200">product-plan/prompts/one-shot-prompt.md</code></li>
