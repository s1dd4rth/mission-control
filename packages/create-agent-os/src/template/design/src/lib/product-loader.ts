...
export function loadProductData(): ProductData {
  const overviewContent = productFiles['/product/mission.md'] || productFiles['/product/product-overview.md']
  const roadmapContent = productFiles['/product/roadmap.md'] || productFiles['/product/product-roadmap.md']
...
export function hasProductOverview(): boolean {
  return '/product/mission.md' in productFiles || '/product/product-overview.md' in productFiles
}
...
export function hasProductRoadmap(): boolean {
  return '/product/roadmap.md' in productFiles || '/product/product-roadmap.md' in productFiles
}
